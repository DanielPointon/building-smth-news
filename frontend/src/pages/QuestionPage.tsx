...
import { ChevronRight, TrendingUp, Calendar, User, ExternalLink } from 'lucide-react';
...
const mockArticles: Article[] = [
  {
    ...
    description: 'An in-depth analysis of how economic changes affect community resilience',
  ...
  },
  {
    ...
    description: 'Exploring the interconnected nature of global economic systems',
    author: 'Michael Chen',
...
const QuestionPage: React.FC = () => {
  ...
  const currentProbability = currentQuestion.data[currentQuestion.data.length - 1].probability;
