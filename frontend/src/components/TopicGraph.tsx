...
const LoadGraph = ({ clusters }: { clusters: Cluster[] }) => {
...
const TopicSidebar = ({ clusters, onClusterSelect }: TopicGraphProps) => (
...
export const TopicGraph: React.FC<TopicGraphProps> = ({ clusters, onClusterSelect }) => {
  return (
